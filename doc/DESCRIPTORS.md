...
| `FractionDegreeOneAtomsDescriptor` | Fraction of atoms with degree 1 | None | `graphoperations.cpp` |
...
| `SmilesAromaticPhosphorusCountDescriptor` | Count of aromatic phosphorus atoms 'p' in the SMILES string | None | `regexcounts.cpp` |
